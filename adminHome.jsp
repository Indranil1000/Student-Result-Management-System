...
<center><img src="Picture1.png" width="100" height="100">
<img src="Picture2.png" align="right"  width="100" height="100" style="padding-right: 20px;"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Digital Communication</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Digital Signal Processing</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Embedded System</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Digital Image & Video Processing</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Web Technology and OOPs</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Digital Image & Video Processing Lab</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Digital Signal Processing Lab</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Digital Communication Lab</label>
                                    <div class="col-md-6">
...
<section>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>Digital Image & Video Processing</th>
          <th>Web Technology and OOPs</th>
          <th>Digital Image & Video Processing Lab</th>
          <th>Digital Signal Processing Lab</th>
           <th>Digital Communication Lab</th>
        </tr>
      </thead>
    </table>
  </div>
  <div class="tbl-content">
      ...
      <tbody>
          ...
          <% 
              try{
                  Connection con=ConnectionProvider.getCon();
                  Statement stmt=con.createStatement();
                  ResultSet rs=stmt.executeQuery("select * from resultrecords");
                  while(rs.next()){
             %>
        <tr>
            <td><%=rs.getString(1)%></td>
    ...
    <hr class="new1">
  <center><h5 style="color: white;">Note: Any errors occur then contact E-Outcome.
Designed & Developed by Indranil Das</h5></center>
  <hr class="new1">
<center><h5 style="color: white;">All Right Reserved @ E-Outcome :: 2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>